 ...
 */var oa=Symbol.for("react.element"),K0=Symbol.for("react.portal"),$0=Symbol.for("react.fragment"),Z0=Symbol.for("react.strict_mode"),Q0=Symbol.for("react.profiler"),J0=Symbol.for("react.provider"),ey=Symbol.for("react.context"),ty=Symbol.for("react.forward_ref"),ny=Symbol.for("react.suspense"),iy=Symbol.for("react.memo"),ry=Symbol.for("react.lazy"),xh=Symbol.iterator;function sy(n){return n===null||typeof n!="object"?null:(n=xh&&n[xh]||n["@@iterator"],typeof n=="function"?n:null)}var Pg={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Lg=Object.assign,Ig={};function Zs(n,e,t){this.props=n,this.context=e,this.refs=Ig,this.updater=t||Pg}Zs.prototype.isReactComponent={};Zs.prototype.setState=function(n,e){if(typeof n!="object"&&typeof n!="function"&&n!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,n,e,"setState")};Zs.prototype.forceUpdate=function(n){this.updater.enqueueForceUpdate(this,n,"forceUpdate")};function Ng(){}Ng.prototype=Zs.prototype;function Yd(n,e,t){this.props=n,this.context=e,this.refs=Ig,this.updater=t||Pg}var qd=Yd.prototype=new Ng;qd.constructor=Yd;Lg(qd,Zs.prototype);qd.isPureReactComponent=!0;var Sh=Array.isArray,Dg=Object.prototype.hasOwnProperty,Kd={current:null},Ug={key:!0,ref:!0,__self:!0,__source:!0};function Fg(n,e,t){var i,r={},s=null,o=null;if(e!=null)for(i in e.ref!==void 0&&(o=e.ref),e.key!==void 0&&(s=""+e.key),e)Dg.call(e,i)&&!Ug.hasOwnProperty(i)&&(r[i]=e[i]);var a=arguments.length-2;if(a===1)r.children=t;else if(1<a){for(var l=Array(a),c=0;c<a;c++)l[c]=arguments[c+2];r.children=l}if(n&&n.defaultProps)for(i in a=n.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:oa,type:n,key:s,ref:o,props:r,_owner:Kd.current}}function oy(n,e){return{$$typeof:oa,type:n.type,key:e,ref:n.ref,props:n.props,_owner:n._owner}}function $d(n){return typeof n=="object"&&n!==null&&n.$$typeof===oa}function ay(n){var e={"=":"=0",":":"=2"};return"$"+n.replace(/[=:]/g,function(t){return e[t]})}var Mh=/\/+/g;function Rc(n,e){return typeof n=="object"&&n!==null&&n.key!=null?ay(""+n.key):e.toString(36)}function cl(n,e,t,i,r){var s=typeof n;(s==="undefined"||s==="boolean")&&(n=null);var o=!1;if(n===null)o=!0;else switch(s){case"string":case"number":o=!0;break;case"object":switch(n.$$typeof){case oa:case K0:o=!0}}if(o)return o=n,r=r(o),n=i===""?"."+Rc(o,0):i,Sh(r)?(t="",n!=null&&(t=n.replace(Mh,"$&/")+"/"),cl(r,e,t,"",function(c){return c})):r!=null&&($d(r)&&(r=oy(r,t+(!r.key||o&&o.key===r.key?"":(""+r.key).replace(Mh,"$&/")+"/")+n)),e.push(r)),1;if(o=0,i=i===""?".":i+":",Sh(n))for(var a=0;a<n.length;a++){s=n[a];var l=i+Rc(s,a);o+=cl(s,e,t,l,r)}else if(l=sy(n),typeof l=="function")for(n=l.call(n),a=0;!(s=n.next()).done;)s=s.value,l=i+Rc(s,a++),o+=cl(s,e,t,l,r);else if(s==="object")throw e=String(n),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.");return o}function va(n,e,t){if(n==null)return n;var i=[],r=0;return cl(n,i,"","",function(s){return e.call(t,s,r++)}),i}function ly(n){if(n._status===-1){var e=n._result;e=e(),e.then(function(t){(n._status===0||n._status===-1)&&(n._status=1,n._result=t)},function(t){(n._status===0||n._status===-1)&&(n._status=2,n._result=t)}),n._status===-1&&(n._status=0,n._result=e)}if(n._status===1)return n._result.default;throw n._result}var en={current:null},ul={transition:null},cy={ReactCurrentDispatcher:en,ReactCurrentBatchConfig:ul,ReactCurrentOwner:Kd};Be.Children={map:va,forEach:function(n,e,t){va(n,function(){e.apply(this,arguments)},t)},count:function(n){var e=0;return va(n,function(){e++}),e},toArray:function(n){return va(n,function(e){return e})||[]},only:function(n){if(!$d(n))throw Error("React.Children.only expected to receive a single React element child.");return n}};Be.Component=Zs;Be.Fragment=$0;Be.Profiler=Q0;Be.PureComponent=Yd;Be.StrictMode=Z0;Be.Suspense=ny;Be.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=cy;Be.cloneElement=function(n,e,t){if(n==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+n+".");var i=Lg({},n.props),r=n.key,s=n.ref,o=n._owner;if(e!=null){if(e.ref!==void 0&&(s=e.ref,o=Kd.current),e.key!==void 0&&(r=""+e.key),n.type&&n.type.defaultProps)var a=n.type.defaultProps;for(l in e)Dg.call(e,l)&&!Ug.hasOwnProperty(l)&&(i[l]=e[l]===void 0&&a!==void 0?a[l]:e[l])}var l=arguments.length-2;if(l===1)i.children=t;else if(1<l){a=Array(l);for(var c=0;c<l;c++)a[c]=arguments[c+2];i.children=a}return{$$typeof:oa,type:n.type,key:r,ref:s,props:i,_owner:o}};Be.createContext=function(n){return n={$$typeof:ey,_currentValue:n,_currentValue2:n,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},n.Provider={$$typeof:J0,_context:n},n.Consumer=n};Be.createElement=Fg;Be.createFactory=function(n){var e=Fg.bind(null,n);return e.type=n,e};Be.createRef=function(){return{current:null}};Be.forwardRef=function(n){return{$$typeof:ty,render:n}};Be.isValidElement=$d;Be.lazy=function(n){return{$$typeof:ry,_payload:{_status:-1,_result:n},_init:ly}};Be.memo=function(n,e){return{$$typeof:iy,type:n,compare:e===void 0?null:e}};Be.startTransition=function(n){var e=ul.transition;ul.transition={};try{n()}finally{ul.transition=e}};Be.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};Be.useCallback=function(n,e){return en.current.useCallback(n,e)};Be.useContext=function(n){return en.current.useContext(n)};Be.useDebugValue=function(){};Be.useDeferredValue=function(n){return en.current.useDeferredValue(n)};Be.useEffect=function(n,e){return en.current.useEffect(n,e)};Be.useId=function(){return en.current.useId()};Be.useImperativeHandle=function(n,e,t){return en.current.useImperativeHandle(n,e,t)};Be.useInsertionEffect=function(n,e){return en.current.useInsertionEffect(n,e)};Be.useLayoutEffect=function(n,e){return en.current.useLayoutEffect(n,e)};Be.useMemo=function(n,e){return en.current.useMemo(n,e)};Be.useReducer=function(n,e,t){return en.current.useReducer(n,e,t)};Be.useRef=function(n){return en.current.useRef(n)};Be.useState=function(n){return en.current.useState(n)};Be.useSyncExternalStore=function(n,e,t){return en.current.useSyncExternalStore(n,e,t)};Be.useTransition=function(){return en.current.useTransition()};Be.version="18.2.0";bg.exports=Be;var mn=bg.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var uy=mn,dy=Symbol.for("react.element"),fy=Symbol.for("react.fragment"),hy=Object.prototype.hasOwnProperty,py=uy.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,my={key:!0,ref:!0,__self:!0,__source:!0};function Og(n,e,t){var i,r={},s=null,o=null;t!==void 0&&(s=""+t),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)hy.call(e,i)&&!my.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:dy,type:n,key:s,ref:o,props:r,_owner:py.current}}nc.Fragment=fy;nc.jsx=Og;nc.jsxs=Og;Cg.exports=nc;var lt=Cg.exports,kg={exports:{}},vn={},Bg={exports:{}},zg={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function Nm(){return new lr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Kf(),fragmentShader:`
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function Dm(){return new lr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Kf(),fragmentShader:`
...
`;function AC(){const n=mn.useRef(null);return mn.useEffect(()=>{if(n.current)return wC(n.current)},[]),lt.jsx("div",{className:"three-scene",ref:n})}function wC(n){const{width:e,height:t}=n.getBoundingClientRect(),i=new Zf,r=new $f({antialias:!0}),s=new Ut(50,e/t,.1,1e3);r.setSize(e,t),r.setPixelRatio(window.devicePixelRatio),n.appendChild(r.domElement),i.background=new ye(16777215),s.position.set(-3,3,7),s.lookAt(0,0,0);const o=new ha({color:16777215,roughness:0,metalness:0,transparent:!0});o.onBeforeCompile=m=>{m.uniforms.uNoise={value:new C0().load("textures/noise.png")},m.vertexShader=m.vertexShader.replace("#include <common>",`#include <common>
        varying vec2 vUv;
      `),m.vertexShader=m.vertexShader.replace("#include <displacementmap_vertex>",`#include <displacementmap_vertex>
        vUv = uv;
      `),m.fragmentShader=m.fragmentShader.replace("#include <clipping_planes_pars_fragment>",`#include <clipping_planes_pars_fragment>
        ${Wd}
        uniform sampler2D uNoise;
        varying vec2 vUv;
      `),m.fragmentShader=m.fragmentShader.replace("#include <dithering_fragment>",`#include <dithering_fragment>
      ...
      `),console.log(m.fragmentShader)};const a=new Qt(new eo(2,2,2),o);i.add(a);const l=new b0(16777215,.4,15,15);l.position.set(0,3,0),l.lookAt(0,0,0),i.add(l);var c=new rh(16777215,200,0,4);c.position.set(2,3,5),i.add(c);const u=ah(n,r,s);let d=0,f=0;const p=lh((m,h)=>{if(m===-1&&h===-1){d=0,f=0;return}f=(m-.5)*2*.7,d=(h-.5)*2*.4});let _=!1;function y(){_||(a&&(a.rotation.x+=(d-a.rotation.x)/6,a.rotation.y+=(f-a.rotation.y)/6),r.render(i,s),requestAnimationFrame(y))}return y(),()=>{_=!0,c.dispose(),i.remove(c),l.dispose(),i.remove(l),a.geometry.dispose(),a.material.dispose(),i.remove(a),i.traverse(m=>{ch(m)&&(m.geometry.dispose(),(Array.isArray(m.material)?m.material:[m.material]).forEach(h=>{uh(h)&&h.map.dispose(),h.dispose()}))}),i.clear(),r.dispose(),r.forceContextLoss(),u(),p(),console.log(r.info)}}class RC{constructor(e,t,i){_a(this,"shader");_a(this,"texture");_a(this,"options");this.name=e,this.stops=t,this.options={interpolation:CC,textureSize:256,...i},this.texture=this.getRamp(this.stops),this.shader=`
      ...
      #endif
    `}set ramp(e){this.texture=this.getRamp(e)}get ramp(){return this.texture}getRamp(e){const t=[],i=new ye,r=new ye,s=e.slice().sort((l,c)=>l.pos-c.pos);let o=0;for(let l=0;l<this.options.textureSize;l++){const c=l/this.options.textureSize,u=s[o],d=s[o+1],f=u.pos,p=(d==null?void 0:d.pos)||1;if(i.set(u.color),r.set((d==null?void 0:d.color)??u.color),console.log(c,f,p,i,r),c<f)t.push(i.r*255,i.g*255,i.b*255,255);else if(c>=f&&c<p){const _=(c-f)/(p-f);t.push(this.options.interpolation(i.r,r.r,_)*255,this.options.interpolation(i.g,r.g,_)*255,this.options.interpolation(i.b,r.b,_)*255,255)}else t.push(r.r*255,r.g*255,r.b*255,255),o++}const a=new Jf(new Uint8Array(t),this.options.textureSize,1);return a.needsUpdate=!0,a}dispose(){this.texture.dispose()}}const CC=function(e,t,i){return e+(t-e)*i},Eg=0;function bC(){const n=mn.useRef(null);return mn.useEffect(()=>{if(n.current)return PC(n.current)},[]),lt.jsx("div",{className:"three-scene",ref:n})}function PC(n){const{width:e,height:t}=n.getBoundingClientRect(),i=new P0,r=new Zf,s=new $f({antialias:!0}),o=new Ut(50,e/t,.1,1e3);s.setSize(e,t),s.setPixelRatio(window.devicePixelRatio),n.appendChild(s.domElement),r.background=new ye(16777215),o.position.set(0,0,7),o.lookAt(0,0,0);const a=new ha({color:16777215,roughness:0,metalness:0});let l;a.onBeforeCompile=v=>{l=v,v.uniforms.uTime={value:0},v.uniforms.uPointing={value:Eg},v.uniforms.uIntensity={value:0};const g=new RC("uRange",[{color:16711680,pos:0},{color:3342336,pos:.2},{color:0,pos:.25},{color:0,pos:.8},{color:3342336,pos:.85},{color:16711935,pos:1}]);v.uniforms[g.name]={value:g.texture},v.vertexShader=v.vertexShader.replace("#include <common>",`#include <common>
        ${Wd}
        ${g.shader}
